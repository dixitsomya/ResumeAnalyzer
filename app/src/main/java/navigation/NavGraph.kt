...
//            val user by UserPreference.getUser(context).collectAsState(initial = null to null)
//
//            SplashContent(onSplashFinished = {
//                when {
//                    user.first != null && user.second == "Student" -> {
//                        navController.navigate("studentMain/${user.first}") {
//                            popUpTo("splash") { inclusive = true }
//                        }
//                    }
//                    user.first != null && user.second == "Recruiter" -> {
